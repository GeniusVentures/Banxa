...
class Coin {
  ...
  bool operator ==(Object other) => identical(this, other) || other is Coin &&
    ...
    other.status == status &&
    _deepEquality.equals(other.blockchains, blockchains);
  ...
  int get hashCode =>
    ...
    (blockchains.hashCode);

  @override
  String toString() => 'Coin[coinCode=$coinCode, coinName=$coinName, status=$status, blockchains=$blockchains]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.coinName != null) {
      json[r'coin_name'] = this.coinName;
    }
    if (this.status != null) {
      json[r'status'] = this.status;
    }
      json[r'blockchains'] = this.blockchains;
    return json;
  }
  ...
  static Coin? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Coin(
        ...
        coinName: mapValueOfType<String>(json, r'coin_name'),
        status: mapValueOfType<String>(json, r'status'),
        blockchains: Blockchain.listFromJson(json[r'blockchains']),
      );
    }
    return null;
  }
