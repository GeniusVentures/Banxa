...
class Pagination {
  ...
  @override
  String toString() => 'Pagination[currentPage=$currentPage, recordsPerPage=$recordsPerPage, totalRecords=$totalRecords, totalPages=$totalPages]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.recordsPerPage != null) {
      json[r'records_per_page'] = this.recordsPerPage;
    }
  ...
  static Pagination? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Pagination(
        ...
        recordsPerPage: mapValueOfType<int>(json, r'records_per_page'),
