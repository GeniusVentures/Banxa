...
class CountriesApi {
  ...
  Future<Response> getCountriesWithHttpInfo(String X_BANXA_SIGNATURE, int X_BANXA_TIMESTAMP, String X_BANXA_NONCE, { int? page, int? perPage, }) async {
  ...
  /// * [int] perPage:
  ///   Number of items per page.
  Future<GetCountriesResponse?> getCountries(String X_BANXA_SIGNATURE, int X_BANXA_TIMESTAMP, String X_BANXA_NONCE, { int? page, int? perPage, }) async {
    final response = await getCountriesWithHttpInfo(X_BANXA_SIGNATURE, X_BANXA_TIMESTAMP, X_BANXA_NONCE,  page: page, perPage: perPage, );
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'GetCountriesResponse',) as GetCountriesResponse;
